...
export function loadConfig(env = process.env): AppConfig {
  ...
  return {
    ...
    indexerUrl: env.INDEXER_URL, indexerApiKey: env.INDEXER_API_KEY, resolverTimeoutMs: Math.min(Number(env.RESOLVER_TIMEOUT_MS ?? 45000), 45000), wyzieApiKey: env.WYZIE_API_KEY,
  };
}
