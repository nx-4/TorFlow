...
- Parallel public adapters for Torrentio, 1337x, EZTV, TorrentGalaxy, YTS, and public audio search. The resolver is strictly torrent-only and returns `NO_HEALTHY_TORRENT` instead of third-party embed URLs.
...
// data.sourceType is always "torrent".
```
